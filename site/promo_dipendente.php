...
$stmt->bind_param("s", $email); // Usa l'email dell'utente loggato
$stmt->execute();
...
// Aggiungiamo una logica di logout se è stato richiesto
if (isset($_GET['logout']) && $_GET['logout'] == 'true') {
    // Chiudi la sessione e redirigi alla pagina di login
    session_unset();
    session_destroy();
...
<head>
    ...
    <link rel="stylesheet" href="style/styles_promo_dipendente.css">
    <title>Promo</title>
</head>
<body>
<header>
...
<script>
    ...
    function confirmLogout() {
        window.location.href = "promo_dipendente.php?logout=true";
    }
</script>
